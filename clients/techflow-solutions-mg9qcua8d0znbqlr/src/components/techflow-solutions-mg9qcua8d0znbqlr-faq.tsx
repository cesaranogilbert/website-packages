...
export function TechflowSolutionsMg9qcua8d0znbqlrFAQ() {
  return (
    <section className="techflow-solutions-mg9qcua8d0znbqlr-faq py-24 bg-gray-50 dark:bg-gray-800" data-testid="faq-techflow-solutions-mg9qcua8d0znbqlr">
          ...
          <Accordion type="single" collapsible>
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`}>
                <AccordionTrigger data-testid={`faq-question-${index}-techflow-solutions-mg9qcua8d0znbqlr`}>
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent data-testid={`faq-answer-${index}-techflow-solutions-mg9qcua8d0znbqlr`}>
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
