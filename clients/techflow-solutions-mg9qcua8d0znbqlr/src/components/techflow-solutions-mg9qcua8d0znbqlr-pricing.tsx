...
export function TechflowSolutionsMg9qcua8d0znbqlrPricing() {
  return (
    <section className="techflow-solutions-mg9qcua8d0znbqlr-pricing py-24 bg-gray-50 dark:bg-gray-800" data-testid="pricing-techflow-solutions-mg9qcua8d0znbqlr">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingTiers.map((tier, index) => (
            <div 
              ...
              data-testid={`pricing-tier-${index}-techflow-solutions-mg9qcua8d0znbqlr`}
            >
              {tier.isPopular && (
              ...
              <Button className="w-full" data-testid={`button-pricing-${index}-techflow-solutions-mg9qcua8d0znbqlr`}>
                Get Started
              </Button>
            </div>
          ))}
