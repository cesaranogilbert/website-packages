...
export function TechflowSolutionsMg9qcua8d0znbqlrFeatures() {
  return (
    <section className="techflow-solutions-mg9qcua8d0znbqlr-features py-24 bg-white dark:bg-gray-900" data-testid="features-techflow-solutions-mg9qcua8d0znbqlr">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div 
                ...
                data-testid={`feature-${index}-techflow-solutions-mg9qcua8d0znbqlr`}
              >
