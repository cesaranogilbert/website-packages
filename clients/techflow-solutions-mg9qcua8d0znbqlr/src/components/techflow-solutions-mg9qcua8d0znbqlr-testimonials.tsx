...
export function TechflowSolutionsMg9qcua8d0znbqlrTestimonials() {
  return (
    <section className="techflow-solutions-mg9qcua8d0znbqlr-testimonials py-24 bg-white dark:bg-gray-900" data-testid="testimonials-techflow-solutions-mg9qcua8d0znbqlr">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div 
              ...
              data-testid={`testimonial-${index}-techflow-solutions-mg9qcua8d0znbqlr`}
            >
